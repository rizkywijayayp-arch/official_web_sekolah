...
export function KelulusanLandingPage() {
  ...
  // School activity photos (memory carousel)
  // In production, this could be fetched from gallery API
  const memoryPhotos = useMemo(() => [
    { id: 1, url: 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=800', caption: 'Upacara Bendera' },
    { id: 2, url: 'https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=800', caption: 'Wisuda' },
    { id: 3, url: 'https://images.unsplash.com/photo-1571260899304-425eee4c7efc?w=800', caption: 'Kegiatan Extrakurikuler' },
    { id: 4, url: 'https://images.unsplash.com/photo-1519451241324-20b4ea2c4220?w=800', caption: 'Pramuka' },
    { id: 5, url: 'https://images.unsplash.com/photo-1427504494785-3a9ca7044f45?w=800', caption: 'Persahabatan' },
    { id: 6, url: 'https://images.unsplash.com/photo-1509062522246-3755977927d7?w=800', caption: 'Ruang Kelas' },
    { id: 7, url: 'https://images.unsplash.com/photo-1580582932707-520aed937b7b?w=800', caption: 'Perpisahan' },
    { id: 8, url: 'https://images.unsplash.com/photo-1606761568499-6d2451b23c66?w=800', caption: 'Kegiatan Sekolah' },
  ], []);
        ...
        <div className="relative z-10 min-h-[calc(100vh-100px)] flex flex-col lg:flex-row items-center justify-center gap-8 px-6 py-12">
          ...
          >
            ...
            >
              ...
              <span className="text-white font-semibold">{announcementDate.toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })} pukul {announcementDate.toLocaleTimeString('id-ID', { hour: '2-digit', minute: '2-digit' })} WIB</span>
            </motion.p>
          ...
          >
            ...
            <div className="absolute -top-3 -right-3 bg-blue-600 text-white px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1 shadow-lg">
              ...
              {memoryPhotos.length} Foto Kenangan
            </div>
          </motion.div>
        </div>
